...
//圣诞游戏
function game(){
    var red = 0,green = 0,blue = 0,orange = 0,yellow = 0,purple = 0,sum = 0,count = 5,time = 60;
    var height = $(window).height();
    var width = $(window).width();
    ...
    var lightOuts = document.getElementsByClassName("lightOut");
    for(var i=0;i<lights.length;i++){
        lightOuts[i].style.display = "none";
        lights[i].addEventListener("click",function(){
            
            lightOuts[parseInt(this.className.substring(10))-1].style.display = "none";
    ...
    var countDown = setInterval(function(){
        ...
        if(count==0){
            ...
            var randomNum = setInterval(function(){
                ...
                $(".LO"+randomnum).css("display","block");
                var shining = setTimeout(function(){
                    $(".LO"+randomnum).css("display","none");
                    clearTimeout(shining);
                },1000);
            },600);
